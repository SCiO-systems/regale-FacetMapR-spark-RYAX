...
use_spark = sys.argv[2]=="True"
previous_outputs = folder + "python_outputs/" 
resume = ""
end = None
arule = None #"/home/christos/Desktop/SCiO_Projects/REGALE/landmapr/LITAP/inst/extdata/arule.dbf"
crule = folder + "data/crule.dbf"
n_remove = 9
procedure = "lsm"
zone = None
out_format = "csv"
...
if resume=="" or resume=="attributes":
    ...
    save_output2(data=fuzzattr, name="fuza", locs=previous_outputs, out_format=out_format, where = "facet", add_db=db[["seqno", "buffer", "row", "col"]])
...
save_output2(data=fuzzattr, name="fuzc", locs=previous_outputs, out_format=out_format, where = "facet", add_db=db[["seqno", "buffer", "row", "col"]])
...
output_file = previous_outputs + "classification_DEM_map.tif"
